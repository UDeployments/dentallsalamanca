    ...
    <tr>
        <td>
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-1" role="presentation"
                   style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #007eae; background-size: auto;"
                   width="100%">
                <tbody>
                <tr>
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack"
                               role="presentation"
                               style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-size: auto; color: #000000; width: 600px;"
                               width="600">
                            <tbody>
                            <tr>
                                        ...
                                        <tr>
                                            <td class="pad"
                                                ...
                                                <div align="center" class="alignment" style="line-height:10px"><img
                                                        ...
                                                        src="https://dentallsalamanca.com/public/images/email/verify/top-rounded.png"
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-2" role="presentation"
                   style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #007eae;" width="100%">
                <tbody>
                <tr>
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block block-1"
                                        ...
                                        <tr>
                                            <td class="pad"
                                                ...
                                                <div align="center" class="alignment" style="line-height:10px"><img
                                                        alt="book shelf" class="big" src="images/shelf.jpg"
                                                        style="display: block; height: auto; border: 0; width: 540px; max-width: 100%;"
                                                        title="book shelf" width="540"/></div>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-3" role="presentation"
                   style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #c1e7f3; background-size: auto;"
                   width="100%">
                <tbody>
                <tr>
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack"
                               role="presentation"
                               style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-size: auto; background-color: #ffffff; color: #000000; width: 600px;"
                               width="600">
                            <tbody>
                            <tr>
                                <td class="column column-1"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="heading_block block-1"
                                        ...
                                        <tr>
                                            <td class="pad"
                                                ...
                                                <h1 style="margin: 0; color: #555555; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 36px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;">
                                                    <strong>Bienvenido a Dent-All</strong></h1>
                                            </td>
                                        </tr>
                                    </table>
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div class=""
                                                        ...
                                                        <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 32.4px;">
                                                            <span style="font-size:18px;">¡Estamos emocionados de que comiences! Primero necesitas confirmar tu cuenta. Simplemente haga clic en el botón de abajo.</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-4" role="presentation"
                   style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #c1e7f3;" width="100%">
                <tbody>
                <tr>
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack"
                            ...
                            <tr>
                                <td class="column column-1"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block block-1"
                                        ...
                                        <tr>
                                            <td class="pad"
                                                style="padding-bottom:35px;padding-top:10px;width:100%;padding-right:0px;padding-left:0px;">
                                                <div align="center" class="alignment" style="line-height:10px"><img
                                                        class="big"
                                                        src="https://dentallsalamanca.com/public/images/email/verify/divider.png"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="text_block block-2"
                                        ...
                                        <tr>
                                            <td class="pad">
                                                <div style="font-family: sans-serif">
                                                    <div class=""
                                                         style="font-size: 14px; mso-line-height-alt: 25.2px; color: #07113e; line-height: 1.8; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
                                                        <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 32.4px;">
                                                            <span style="font-size:18px;">Síguenos en</span></p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                    <table border="0" cellpadding="0" cellspacing="0" class="social_block block-3"
                                           role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"
                                           width="100%">
                                        <tr>
                                            <td class="pad"
                                                        ...
                                                        <tr>
                                                            <td style="padding:0 7px 0 7px;"><a
                                                                    ...
                                                                    target="_blank"><img alt="Facebook" height="32"
                                                                                         src="https://dentallsalamanca.com/public/images/email/verify/facebook2x.png"
                                                            ...
                                                            <td style="padding:0 7px 0 7px;"><a
                                                                    href="https://twitter.com/" target="_blank"><img
                                                                        ...
                                                                        src="https://dentallsalamanca.com/public/images/email/verify/twitter2x.png"
                                                                        style="display: block; height: auto; border: 0;"
                                                                        title="Twitter" width="32"/></a></td>
                                                            <td style="padding:0 7px 0 7px;"><a
                                                                    href="https://instagram.com/" target="_blank"><img
                                                                        alt="Instagram" height="32"
                                                                        src="https://dentallsalamanca.com/public/images/email/verify/instagram2x.png"
                                                                        style="display: block; height: auto; border: 0;"
                            ...
                            <tr>
                                <td class="column column-1"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block block-1"
                                        ...
                                        <tr>
                                            <td class="pad"
                                                style="width:100%;padding-right:0px;padding-left:0px;padding-bottom:60px;">
                                                <div align="center" class="alignment" style="line-height:10px"><img
                                                        class="fullMobileWidth"
                                                        src="https://dentallsalamanca.com/public/images/email/verify/bottom-rounded.png"
                                                        style="display: block; height: auto; border: 0; width: 600px; max-width: 100%;"
                                                        width="600"/></div>
                                            </td>
                                        </tr>
